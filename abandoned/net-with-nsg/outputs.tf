...
output "nsg_ids" {
  description = "Map of NSG IDs keyed by logical subnet key."
  value = {
...
output "nsg_names" {
  description = "Map of NSG names keyed by logical subnet key."
  value = {
    for key, nsg in azurerm_network_security_group.this : key => nsg.name
  }
}
